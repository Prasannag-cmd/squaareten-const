...
const projectsData = [
  ...
  // Available Houses
  {
    id: 'aura-heights-duplex',
    name: 'Aura Heights Duplex',
    location: 'Chennai, Tamil Nadu',
    category: 'projects',
    status: 'Available House',
    img: '/assets/images/project-duplex-main.jpg',
    description: 'Premium 3 BHK duplex house with private terrace, modern automation, and modular kitchen.',
    area: '2,200 sq.ft',
    bedrooms: '3 BHK',
    price: '₹1.15 Crores',
  },
  {
    id: 'signature-garden-villa',
    name: 'Signature Garden Villa',
    location: 'Madurai, Tamil Nadu',
    category: 'projects',
    status: 'Available House',
    img: '/assets/images/project-villa.png',
    description: 'Exclusive 4 BHK independent villa featuring private lawns, wooden deck, and energy-efficient architecture.',
    area: '3,100 sq.ft',
    bedrooms: '4 BHK',
    price: '₹1.85 Crores',
  },
